...
final public class FormViewModelFactoryImpl implements FormViewModelFactory {
    ...
    public FormViewModelFactoryImpl(@NonNull EditTextHintCache editTextHintCache) {
        this.editTextHintCache = editTextHintCache;
    }

    @Override
    public FormViewModel fromCursor(@NonNull Cursor cursor) {
    ...
    @Override
    public FormViewModel create(@NonNull String uid, @NonNull String label, @NonNull Boolean mandatory,
    ...
    @NonNull
    private FormViewModel createRadioButtonViewModel(@NonNull String uid, @NonNull String label,
    ...
    @NonNull
    private FormViewModel createCoordinateViewModel(@NonNull String uid, @NonNull String label,
                                                    @NonNull Boolean mandatory, @Nullable String value) {
        Double latitude;
        Double longitude;
